namespace BlogEngine.Core
{
    ...
    public class Post : BusinessBase<Post, Guid>, IComparable<Post>, IPublishable
    {
        ...
        private StateList<PostVerse> versesList;
        ...
        public Post()
        {
            ...
            this.versesList = new StateList<PostVerse>();
        ...
        public string Verses
        {
            ...
            set
            {
                base.SetValue("Verses", value, ref this.verses);
            }
        }

        public StateList<PostVerse> VersesList
        {
            get
            {
            ...
            set
            {
                base.SetValue("VersesList", value, ref this.versesList);
            }
        }
        ...
        public string Summary
        {
            ...
            set
            {
                base.SetValue("Summary", value, ref this.summary);
            }
        }
        ...
        /// <summary>
        ///     Gets or sets the chapterNumber or the post.
        /// </summary>
        public int ChapterNumber
        {
            ...
            set
            {
                base.SetValue("chapterNumber", value, ref this.chapterNumber);
            }
        }
        ...
        StateList<PostVerse> IPublishable.Verses
        {
            get { return VersesList; }
        }
